...
setup(name = "pipits",
      ...
      packages = ["pipits"],
      scripts = ["bin/pipits_retrain_rdp", "bin/pipits_getreadpairslist", "bin/pipits_prep", "bin/pipits_funits", "bin/pipits_dereplicate_fasta", "bin/pipits_fasta_filter_by_length", "bin/pipits_inflate_fasta", "bin/pipits_process", "bin/pipits_uc2otutable", "bin/pipits_reformatAssignedTaxonomy", "bin/pipits_phylotype_biom"],
